...
export default function TestPage() {
    ...
    if (showResults) {
        return <TestResultsView score={score} selectedTest={selectedTest} onResetTest={resetTest} />;
    }

    // Show test runner during the test
    return <TestRunner selectedTest={selectedTest} onTestComplete={handleTestComplete} />;
}
