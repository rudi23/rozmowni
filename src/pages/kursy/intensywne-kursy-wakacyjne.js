                ...
                <div className="row">
                    <div className="col-lg-12">
                        <CourseHeader title="ROZGADAJ SIĘ W WAKACJE" className="pt-3 pb-3">
                            ...
                            <h3 className="pt-2 pb-4">Wakacyjny kurs konwersacji w języku angielskim dla dorosłych</h3>
                            <p>
                            ...
                            <p>
                                Tryb zajęć: <strong>Online</strong> (przez platformę internetową Google Meets lub Zoom)
                            </p>

                            <h4 className="pt-2 pb-2">Program kursu:</h4>
                            <p>
                                Nasze zajęcia opierają się na praktycznych ćwiczeniach konwersacyjnych, które pomogą Ci
                                zdobyć pewność siebie i płynność w używaniu języka angielskiego. Podczas kursu będziesz
                                uczestniczyć w różnorodnych interaktywnych zajęciach, takich jak:
                            </p>
                            <ul className="pt-2 pb-2">
                                <li>
                                    ...
                                    <p>
                                        ...
                                        codzienne, praca, hobby i wiele innych. Będziesz mieć okazję ćwiczyć słuchanie,
                                        mówienie i rozumienie, korzystając z różnorodnego materiału do dyskusji.
                                    </p>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <p>
                                        Weźmiesz udział w grupowych dyskusjach, które pomogą Ci rozwijać umiejętności
                                        słuchania i mówienia w większym gronie. Poruszać będziemy aktualne tematy
                                        społeczne, kulturalne i biznesowe, aby zapewnić Ci praktykę w różnych
                                        kontekstach.
                                    </p>
                                </li>
                            </ul>
                            ...
                            <p>
                                Cena obejmuje <strong>10 spotkań</strong> po <strong>2 lekcje 45-cio minutowe</strong> w
                                grupie <strong>4-6 osobowej</strong>. Łącznie 20 lekcji x 45 min
                            </p>
                            <p>
                                Zajęcia <strong>zaczynają się 10 lipca, a kończą 31 lipca.</strong> Dla osób chętnych
                                przewidziana jest możliwość kontynuacji kursu w sierpniu.
                            </p>
                            <p>
