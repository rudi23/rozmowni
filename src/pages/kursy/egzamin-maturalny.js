                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="course-single-header">
                            ...
                            <p>
                                Czy zbliża się termin Twojego egzaminu maturalnego z języka angielskiego, a Ty chcesz
                                się solidnie i skutecznie przygotować?
                            </p>
                            ...
                            <ul className="mb-2">
                                <li>
                                    Doświadczeni nauczyciele: Nasz zespół nauczycieli to eksperci w dziedzinie nauczania
                                    języka angielskiego, którzy posiadają wieloletnie doświadczenie w przygotowywaniu
                                    uczniów do egzaminów maturalnych.
                                </li>
                                <li>
                                    Indywidualne podejście: Rozumiemy, że każdy maturzysta ma własne mocne strony i
                                    obszary do poprawy. Dlatego nasz kurs jest dostosowany do Twojego poziomu, potrzeb i
                                    celów, zapewniając indywidualne podejście.
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    języka angielskiego. Pracujemy nad umiejętnościami rozumienia ze słuchu, czytania,
                                    mówienia i pisania, a także nad strategiami egzaminacyjnymi.
                                </li>
                                <li>
                                ...
                                <li>
                                    Elastyczny harmonogram: Dostosowujemy się do Twojego planu, abyś mógł uczęszczać na
                                    zajęcia w dogodnych dla Ciebie godzinach.
                                </li>
                                <li>
                                    Śledzenie postępów: Regularnie oceniamy Twoje postępy i dostarczamy Ci informacje
                                    zwrotne, dzięki czemu będziesz wiedział/a, na czym jeszcze musisz popracować.
                                </li>
                                <li>
                            ...
                            <p>
                                Zapisz się na nasz kurs przygotowawczy do egzaminu maturalnego z języka angielskiego i
                                zwiększ swoje szanse na uzyskanie wysokiej oceny!
                            </p>
                            <p>
                                Skontaktuj się z nami już teraz, aby dowiedzieć się więcej o naszym kursie, dostępnych
                                terminach i cenie.
                            </p>
