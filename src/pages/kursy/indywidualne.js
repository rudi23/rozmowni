                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="course-single-header">
                            ...
                            <p>
                                Lekcje indywidualne można porównać do usługi szycia dokładnie na Twoją miarę. Podczas
                                zajęć indywidualnych cała uwaga nauczyciela jest skupiona tylko na Tobie i Twoich
                                potrzebach. Materiał dostosowany jest do Ciebie, Twojego tempa, interesujących Cię
                                tematów i materiałów, które trafią do Ciebie najlepiej. Możemy skupić się na
                                konwersacjach, powtórce gramatyki lub ćwiczyć angielski biznesowy.
                            </p>
                        </div>
