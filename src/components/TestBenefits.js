    ...
    <Section>
      <div className="row justify-content-center">
        <div className="col-lg-10 text-center">
          <SectionHeading
            heading="Co zyskujesz robiąc BEZPŁATNY test?"
            subheading="Więcej niż myślisz!"
          />
          <p className={styles.intro}>
            Nasz test to nie tylko sprawdzenie poziomu - to kompletny pakiet
            startowy do Twojej przygody z angielskim
          </p>
        </div>
      </div>
      <div className="row">
        <div className="col-lg-6 col-md-6 mb-4">
          <div className={styles.benefit}>
            ...
            <h4>Wynik testu</h4>
            <p>
              Natychmiastowe określenie Twojego poziomu językowego (A1-C2) po
              zakończeniu testu
            </p>
        ...
        <div className="col-lg-6 col-md-6 mb-4">
          <div className={styles.benefit}>
            ...
            <p>
              30-minutowa indywidualna lekcja on-line z doświadczonym lektorem
            </p>
        ...
        <div className="col-lg-6 col-md-6 mb-md-0 mb-4">
          <div className={styles.benefit}>
            ...
            <p>
              Indywidualna ścieżka rozwoju przygotowana podczas lekcji próbnej,
              dopasowana do Twojego poziomu i celów
            </p>
            <div className={styles.value}>Wartość: 100 zł</div>
          </div>
        </div>
        ...
        <div className="col-lg-6 col-md-6">
          <div className={`${styles.benefit} ${styles.highlighted}`}>
            ...
            <p>
              "Czas na angielski" - 12-stronicowy przewodnik po wszystkich
              czasach angielskich (podstawowe, potrzebne i mistrzowskie) z
              przykładami
            </p>
            <div className={styles.value}>Wartość: 100 zł</div>
            ...
            <div className="row align-items-center">
              <div className="col-lg-8">
                ...
                <p className="mb-4 mb-lg-0">
                  Dla Ciebie:{' '}
                  <strong className={styles.freeText}>GRATIS</strong>
                </p>
              </div>
