    ...
    <Section>
      <div className="row align-items-center">
        ...
        <div className="col-lg-6 col-md-12">
          ...
          <p>
            W rozmowni.pl nie tylko uczysz się angielskiego – rozwijasz
            kompetencje przyszłości przez fascynujące konwersacje o rozwoju
            osobistym, psychologii i tematach, które naprawdę mają znaczenie.
          </p>

          <p>Kursy prowadzimy online na wszystkich poziomach zaawansowania.</p>
          <p>
            Sprawdź poniżej, jak określić swój poziom, poznać nasze unikalne
            podejście do nauki i otrzymać bezpłatną lekcję próbną.
          </p>
          <p>
            Dołącz do nas i odkryj, jak angielski może stać się narzędziem
            Twojego osobistego rozwoju.
          </p>
