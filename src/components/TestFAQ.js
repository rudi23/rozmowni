...
// Ordered so that a `limit` keeps the objections that matter most before the
// first click: time, price, when the result comes, spam, commitment.
const faqs = [
  {
    q: 'Ile czasu zajmuje test?',
    a: 'Test trwa około 10 minut. Jest szybki, ale bardzo precyzyjny w ocenie Twojego poziomu. Składa się z 25 pytań dostosowanych do Twojego wieku.',
  },
  {
...
// Rendered on the home page (a short list plus the CTA box) and on the test
// page itself (every question, no CTA - the test is one scroll up).
export default function TestFAQ({ limit, showCta = true, background }) {
        ...
        <div className="col-lg-8">
          <div className="text-center">
            ...
            <p className={styles.intro}>
              Odpowiadamy na wszystkie pytania, które mogą Cię nurtować przed
              zrobieniem testu
            </p>
          </div>
          ...
          <div className={styles.faqContainer}>
            <Accordion
              ...
              cards={shown.map((faq, index) => ({
                ...
                // Prefixed: plain indexes collided with the ids of the other
          ...
          {showCta && (
            <div className={styles.faqCta}>
              <div className={styles.ctaBox}>
                <h3>Masz inne pytanie?</h3>
                <p>
                  Zrób test, a podczas <strong>darmowej konsultacji</strong>{' '}
