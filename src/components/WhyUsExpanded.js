...
import { faPlay, faCheck, faHeart, faBrain, faUsers, faGraduationCap } from '@fortawesome/free-solid-svg-icons';
    ...
    const whyUsItems = [
        {
            ...
            content: (
                <>
                    <p>
                        <strong>
                            Szkoła rozmowni.pl jest dla Ciebie, jeśli chcesz rozmawiać po angielsku na tematy, które
                    ...
                    <p className={styles.highlight}>
                        <strong>Na zajęciach często rozmawiamy na tematy kontrowersyjne</strong> z poszanowaniem
        ...
        },
        {
            ...
            content: (
                <>
                    <p>
                        <strong>
                            Uczymy się angielskiego i równocześnie ćwiczymy umiejętności, które będą potrzebne w
                            przyszłości:
                        </strong>
                    </p>
                ...
                <>
                    ...
                    <div className={styles.atmosphereFeatures}>
                        <div className={styles.feature}>
                            ...
                            <span>Odpowiada Ci przyjazna atmosfera bez szkolnych ocen i testów</span>
                        </div>
                        <div className={styles.feature}>
                            <FontAwesomeIcon icon={faCheck} />
                        ...
                        <div className={styles.feature}>
                            <FontAwesomeIcon icon={faCheck} />
                            <span>Chcesz otworzyć się, popełniać błędy i eksperymentować</span>
                        </div>
                        <div className={styles.feature}>
                            <FontAwesomeIcon icon={faCheck} />
        ...
        },
        {
            ...
            content: (
                <>
                    <p>
                        <strong>Szkoła rozmowni.pl jest dla Ciebie, jeśli przygotowujesz się do:</strong>
                    </p>
                    ...
                    <p className={styles.motivationFooter}>
                        <strong>
                            Niezależnie od Twojej motywacji - z chęcią będziemy Ci towarzyszyć w drodze do upragnionej
                            płynności językowej.
                        </strong>
                    </p>
                </>
                ...
                <div className="col-12">
                    <div className={styles.textWithFloatingImage}>
                        ...
                        <div className={styles.introText}>
                            <p>
                                Skoro tu jesteś, to pewnie ktoś Ci nas polecił albo samodzielnie znalazłeś nas, szukając
                                szkoły, w której wreszcie zaczniesz swobodnie mówić po angielsku.
                            </p>
                            <p>
                                W Rozmowni.pl uczysz się języka tak, jak używa się go w prawdziwym życiu — w rozmowie.
                                Rozmawiamy o tym, co Cię interesuje i inspiruje: rozwoju osobistym, psychologii,
                                filozofii, relacjach, zdrowym stylu życia, kulturach świata czy bieżących wydarzeniach.
                                Podejmujemy też tematy kontrowersyjne — zawsze z szacunkiem dla innych punktów widzenia.
                            </p>
                            <p>
                                Niezależnie, czy uczysz się do egzaminu, przygotowujesz do pracy marzeń, czy chcesz
                                swobodnie podróżować — pomożemy Ci osiągnąć Twój cel.
                            </p>
                            <p>Wszystko w przyjaznej atmosferze, z dużą dawką wsparcia i motywacji.</p>
                            <p className={styles.goodMatch}>
                                <strong>
                                    Gotowy na rozpoczęcie przygody z angielskim? Sprawdź szczegóły naszej oferty
                                    poniżej!
                                </strong>
                            </p>
                        </div>
            ...
            <div className="row mt-3">
                <div className="col-12">
                    <div className={styles.expandedSection}>
                        <h3 className={styles.expandedTitle}>Poznaj nas lepiej - sprawdź szczegóły:</h3>
                            ...
                            cards={whyUsItems.map((item) => ({
                                title: (
                                    <span className={styles.accordionTitle}>
                                        <FontAwesomeIcon icon={item.icon} className={styles.titleIcon} />
                                        {item.title}
                                    </span>
                                ),
                                id: item.id,
